...
export const zh_CN: Translation = {
	...
	[Key.liveReportSubtitle]:
		"记录每一次开播的日期、平台、时长与标题，以及各平台粉丝的每日增减",
	[Key.liveReportNotConfigured]: "未配置直播数据源",
	[Key.liveReportNotConfiguredDesc]:
		"请在 src/config/live-report.config.json 中填写 B站 UID 与抖音 sec_uid",
	[Key.liveReportLastUpdated]: "数据更新于",
	[Key.liveReportLiveDays]: "直播天数",
	[Key.liveReportStreamCount]: "直播场次",
	[Key.liveReportTotalDuration]: "总时长",
	[Key.liveReportAverageDuration]: "平均时长",
	[Key.liveReportLongestDuration]: "最长一场",
	[Key.liveReportSinceLastStream]: "距离上次直播",
	[Key.liveReportDayUnit]: "天",
	[Key.liveReportCalendar]: "直播月历",
	[Key.liveReportCalendarDesc]:
		"点亮的日期表示当天开播过，点击日期查看平台、时长与直播标题",
	[Key.liveReportFollowerChart]: "粉丝报表",
	...
	[Key.liveReportDecrease]: "减",
	[Key.liveReportNoData]: "暂无数据",
	[Key.liveReportNoDataDesc]: "抓取脚本运行后，这里会自动出现数据",
	[Key.liveReportNoLiveThisMonth]: "本月还没有直播记录",
	[Key.liveReportPlatformAll]: "全部",
	[Key.liveReportPlatformBilibili]: "B站",
	[Key.liveReportPlatformDouyin]: "抖音",
	[Key.liveReportStreaming]: "直播中",
	[Key.liveReportDuration]: "时长",
	[Key.liveReportStreamTitle]: "直播标题",
	[Key.liveReportOpenRoom]: "前往直播间",
	[Key.liveReportManual]: "手动补录",
	[Key.liveReportThisMonth]: "本月",
	[Key.liveReportPrevMonth]: "上一月",
	[Key.liveReportNextMonth]: "下一月",
	[Key.liveReportToday]: "今天",
	[Key.liveReportNoFollowerData]: "暂无粉丝快照数据",
	[Key.liveReportBaseline]: "起始",
	[Key.liveReportHourUnit]: "小时",
	[Key.liveReportMinuteUnit]: "分钟",
	[Key.liveReportMonthlyOverview]: "本月概览",
	[Key.liveReportSelectedDay]: "当日直播",
	[Key.liveReportSelectDayHint]: "点击月历中的日期查看当天详情",
	[Key.liveReportNoStreamThisDay]: "这一天没有直播",
	[Key.liveReportDataRange]: "数据范围",
	[Key.liveReportAutoCollected]: "由 GitHub Actions 自动采集",
