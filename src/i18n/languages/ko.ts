...
export const ko: Translation = {
	...
	// 라이브 리포트
	[Key.liveReport]: "라이브 리포트",
	[Key.liveReportSubtitle]:
		"방송 날짜·플랫폼·시간·제목과 플랫폼별 팔로워 증감을 기록합니다",
	[Key.liveReportNotConfigured]: "라이브 데이터 소스가 설정되지 않았습니다",
	[Key.liveReportNotConfiguredDesc]:
		"src/config/live-report.config.json 에 Bilibili UID 와 Douyin sec_uid 를 입력하세요",
	[Key.liveReportLastUpdated]: "데이터 갱신 시각",
	[Key.liveReportLiveDays]: "방송 일수",
	[Key.liveReportStreamCount]: "방송 횟수",
	...
	[Key.liveReportNoDataDesc]:
		"수집 스크립트가 실행되면 여기에 데이터가 표시됩니다",
	[Key.liveReportNoLiveThisMonth]: "이번 달 방송 기록이 없습니다",
	[Key.liveReportPlatformAll]: "전체",
	[Key.liveReportPlatformBilibili]: "Bilibili",
	[Key.liveReportPlatformDouyin]: "Douyin",
	[Key.liveReportStreaming]: "방송 중",
	[Key.liveReportDuration]: "방송 시간",
	[Key.liveReportStreamTitle]: "방송 제목",
	[Key.liveReportOpenRoom]: "방송국 열기",
	[Key.liveReportManual]: "수동 입력",
	[Key.liveReportThisMonth]: "이번 달",
	[Key.liveReportPrevMonth]: "지난달",
	[Key.liveReportNextMonth]: "다음 달",
	[Key.liveReportToday]: "오늘",
	[Key.liveReportNoFollowerData]: "팔로워 스냅샷이 없습니다",
	[Key.liveReportBaseline]: "시작",
	[Key.liveReportHourUnit]: "시간",
	[Key.liveReportMinuteUnit]: "분",
	[Key.liveReportMonthlyOverview]: "이번 달 개요",
	[Key.liveReportSelectedDay]: "해당일 방송",
	[Key.liveReportSelectDayHint]:
		"달력에서 날짜를 클릭하면 상세 정보를 볼 수 있습니다",
	[Key.liveReportNoStreamThisDay]: "이 날짜에는 방송이 없습니다",
	[Key.liveReportDataRange]: "데이터 범위",
	[Key.liveReportAutoCollected]: "GitHub Actions 로 자동 수집",
