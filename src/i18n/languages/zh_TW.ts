...
export const zh_TW: Translation = {
	...
	[Key.liveReportSubtitle]:
		"記錄每一次開播的日期、平台、時長與標題，以及各平台粉絲的每日增減",
	[Key.liveReportNotConfigured]: "未配置直播資料來源",
	[Key.liveReportNotConfiguredDesc]:
		"請在 src/config/live-report.config.json 中填寫 B站 UID 與抖音 sec_uid",
	[Key.liveReportLastUpdated]: "資料更新於",
	[Key.liveReportLiveDays]: "直播天數",
	[Key.liveReportStreamCount]: "直播場次",
	...
	[Key.liveReportCalendarDesc]:
		"點亮的日期表示當天開播過，點擊日期查看平台、時長與直播標題",
	[Key.liveReportFollowerChart]: "粉絲報表",
	[Key.liveReportFollowerChartDesc]: "柱狀圖展示各平台每日粉絲的增減情況",
	[Key.liveReportFollowerTotal]: "當前粉絲",
	[Key.liveReportNetChange]: "區間淨增",
	[Key.liveReportHeroButton]: "查看直播資料",
	[Key.liveReportFollowerBaselineHint]:
		"還需要至少兩天的快照資料，才能看出每日增減",
	[Key.liveReportIncrease]: "增",
	[Key.liveReportDecrease]: "減",
	[Key.liveReportNoData]: "暫無資料",
	[Key.liveReportNoDataDesc]: "抓取腳本運行後，這裡會自動出現資料",
	[Key.liveReportNoLiveThisMonth]: "本月還沒有直播記錄",
	[Key.liveReportPlatformAll]: "全部",
	[Key.liveReportPlatformBilibili]: "B站",
	[Key.liveReportPlatformDouyin]: "抖音",
	[Key.liveReportStreaming]: "直播中",
	[Key.liveReportDuration]: "時長",
	[Key.liveReportStreamTitle]: "直播標題",
	[Key.liveReportOpenRoom]: "前往直播間",
	[Key.liveReportManual]: "手動補錄",
	[Key.liveReportThisMonth]: "本月",
	[Key.liveReportPrevMonth]: "上一月",
	[Key.liveReportNextMonth]: "下一月",
	[Key.liveReportToday]: "今天",
	[Key.liveReportNoFollowerData]: "暫無粉絲快照資料",
	[Key.liveReportBaseline]: "起始",
	[Key.liveReportHourUnit]: "小時",
	[Key.liveReportMinuteUnit]: "分鐘",
	[Key.liveReportMonthlyOverview]: "本月概覽",
	[Key.liveReportSelectedDay]: "當日直播",
	[Key.liveReportSelectDayHint]: "點擊月曆中的日期查看當天詳情",
	[Key.liveReportNoStreamThisDay]: "這一天沒有直播",
	[Key.liveReportDataRange]: "資料範圍",
	[Key.liveReportAutoCollected]: "由 GitHub Actions 自動採集",
