...
export const en: Translation = {
	...
	// Live report
	[Key.liveReport]: "Live Report",
	[Key.liveReportSubtitle]:
		"Date, platform, duration and title of every stream, plus daily follower changes",
	[Key.liveReportNotConfigured]: "Live data source not configured",
	[Key.liveReportNotConfiguredDesc]:
		"Fill in your Bilibili UID and Douyin sec_uid in src/config/live-report.config.json",
	[Key.liveReportLastUpdated]: "Data updated at",
	[Key.liveReportLiveDays]: "Stream days",
	[Key.liveReportStreamCount]: "Streams",
	...
	[Key.liveReportCalendarDesc]:
		"Highlighted days had a stream — click a day for platform, duration and title",
	[Key.liveReportFollowerChart]: "Follower report",
	...
	[Key.liveReportHeroButton]: "View live data",
	...
	[Key.liveReportNoDataDesc]: "Data shows up here after the collector runs",
	[Key.liveReportNoLiveThisMonth]: "No stream recorded this month",
	[Key.liveReportPlatformAll]: "All",
	[Key.liveReportPlatformBilibili]: "Bilibili",
	[Key.liveReportPlatformDouyin]: "Douyin",
	[Key.liveReportStreaming]: "Live now",
	[Key.liveReportDuration]: "Duration",
	[Key.liveReportStreamTitle]: "Stream title",
	[Key.liveReportOpenRoom]: "Open room",
	[Key.liveReportManual]: "Manual",
	[Key.liveReportThisMonth]: "This month",
	[Key.liveReportPrevMonth]: "Previous month",
	[Key.liveReportNextMonth]: "Next month",
	[Key.liveReportToday]: "Today",
	[Key.liveReportNoFollowerData]: "No follower snapshots yet",
	[Key.liveReportBaseline]: "Start",
	[Key.liveReportHourUnit]: "h",
	[Key.liveReportMinuteUnit]: "min",
	[Key.liveReportMonthlyOverview]: "Monthly overview",
	[Key.liveReportSelectedDay]: "Streams that day",
	[Key.liveReportSelectDayHint]:
		"Click a date in the calendar to see the details",
	[Key.liveReportNoStreamThisDay]: "No stream on this day",
	[Key.liveReportDataRange]: "Data range",
	[Key.liveReportAutoCollected]: "Collected automatically by GitHub Actions",
