...
export const ja: Translation = {
	...
	// ライブレポート
	[Key.liveReport]: "ライブレポート",
	[Key.liveReportSubtitle]:
		"配信ごとの日付・プラットフォーム・配信時間・タイトルと、各プラットフォームのフォロワー増減",
	[Key.liveReportNotConfigured]: "ライブデータソースが未設定です",
	[Key.liveReportNotConfiguredDesc]:
		"src/config/live-report.config.json に Bilibili UID と Douyin sec_uid を入力してください",
	[Key.liveReportLastUpdated]: "データ更新日時",
	[Key.liveReportLiveDays]: "配信日数",
	[Key.liveReportStreamCount]: "配信回数",
	...
	[Key.liveReportCalendarDesc]:
		"色が付いた日は配信があった日です。クリックするとプラットフォーム・時間・タイトルを確認できます",
	[Key.liveReportFollowerChart]: "フォロワーレポート",
	...
	[Key.liveReportNoData]: "データがありません",
	[Key.liveReportNoDataDesc]:
		"収集スクリプトの実行後、ここにデータが表示されます",
	[Key.liveReportNoLiveThisMonth]: "今月の配信記録はありません",
	[Key.liveReportPlatformAll]: "すべて",
	[Key.liveReportPlatformBilibili]: "Bilibili",
	[Key.liveReportPlatformDouyin]: "Douyin",
	[Key.liveReportStreaming]: "配信中",
	[Key.liveReportDuration]: "配信時間",
	[Key.liveReportStreamTitle]: "配信タイトル",
	[Key.liveReportOpenRoom]: "配信ルームを開く",
	[Key.liveReportManual]: "手動入力",
	[Key.liveReportThisMonth]: "今月",
	[Key.liveReportPrevMonth]: "前月",
	[Key.liveReportNextMonth]: "翌月",
	[Key.liveReportToday]: "今日",
	[Key.liveReportNoFollowerData]: "フォロワーの記録がありません",
	[Key.liveReportBaseline]: "開始",
	[Key.liveReportHourUnit]: "時間",
	[Key.liveReportMinuteUnit]: "分",
	[Key.liveReportMonthlyOverview]: "今月の概要",
	[Key.liveReportSelectedDay]: "当日の配信",
	[Key.liveReportSelectDayHint]:
		"カレンダーの日付をクリックすると詳細を表示します",
	[Key.liveReportNoStreamThisDay]: "この日の配信はありません",
	[Key.liveReportDataRange]: "データ範囲",
	[Key.liveReportAutoCollected]: "GitHub Actions により自動収集",
