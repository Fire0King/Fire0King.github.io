...
export const ru: Translation = {
	...
	// Отчёт о трансляциях
	[Key.liveReport]: "Отчёт о трансляциях",
	[Key.liveReportSubtitle]:
		"Дата, платформа, длительность и название каждой трансляции, а также ежедневный прирост подписчиков",
	[Key.liveReportNotConfigured]: "Источник данных не настроен",
	[Key.liveReportNotConfiguredDesc]:
		"Укажите Bilibili UID и Douyin sec_uid в src/config/live-report.config.json",
	[Key.liveReportLastUpdated]: "Данные обновлены",
	[Key.liveReportLiveDays]: "Дней с эфирами",
	[Key.liveReportStreamCount]: "Трансляций",
	...
	[Key.liveReportCalendarDesc]:
		"Подсвеченные дни — были эфиры. Нажмите на день, чтобы увидеть платформу, длительность и название",
	[Key.liveReportFollowerChart]: "Отчёт по подписчикам",
	[Key.liveReportFollowerChartDesc]:
	...
	[Key.liveReportDecrease]: "Убыль",
	[Key.liveReportNoData]: "Нет данных",
	[Key.liveReportNoDataDesc]: "Данные появятся здесь после запуска сборщика",
	[Key.liveReportNoLiveThisMonth]: "В этом месяце трансляций нет",
	[Key.liveReportPlatformAll]: "Все",
	[Key.liveReportPlatformBilibili]: "Bilibili",
	[Key.liveReportPlatformDouyin]: "Douyin",
	[Key.liveReportStreaming]: "В эфире",
	[Key.liveReportDuration]: "Длительность",
	[Key.liveReportStreamTitle]: "Название трансляции",
	[Key.liveReportOpenRoom]: "Открыть комнату",
	[Key.liveReportManual]: "Вручную",
	[Key.liveReportThisMonth]: "Этот месяц",
	[Key.liveReportPrevMonth]: "Предыдущий месяц",
	[Key.liveReportNextMonth]: "Следующий месяц",
	[Key.liveReportToday]: "Сегодня",
	[Key.liveReportNoFollowerData]: "Нет снимков подписчиков",
	[Key.liveReportBaseline]: "Старт",
	[Key.liveReportHourUnit]: "ч",
	[Key.liveReportMinuteUnit]: "мин",
	[Key.liveReportMonthlyOverview]: "Обзор месяца",
	[Key.liveReportSelectedDay]: "Эфиры за день",
	[Key.liveReportSelectDayHint]:
		"Нажмите на дату в календаре, чтобы увидеть детали",
	[Key.liveReportNoStreamThisDay]: "В этот день трансляций не было",
	[Key.liveReportDataRange]: "Диапазон данных",
	[Key.liveReportAutoCollected]:
